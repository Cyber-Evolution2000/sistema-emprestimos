// ✅ SISTEMA ADMIN - SEMPRE USA BANCO DE DADOS
...
// ✅ CARREGAR CLIENTES - SEMPRE DA API
        ...
        tbody.innerHTML = `
            <tr>
                <td colspan="6" class="text-center text-danger py-4">
                    ...
                    <small>Verifique se o banco de dados está online</small>
                </td>
            </tr>
        `;
...
// ✅ CARREGAR EMPRÉSTIMOS - SEMPRE DA API
async function carregarEmprestimos() {
    try {
        console.log('🔄 Carregando empréstimos da API...');
...
// ✅ MODAL CLIENTE - SEMPRE SALVA NA API
...
async function salvarCliente() {
    try {
        ...
        console.log('💾 Salvando cliente na API:', clienteData);
...
// ✅ MODAL EMPRÉSTIMO - SEMPRE SALVA NA API
async function abrirModalEmprestimo(emprestimoId = null) {
    try {
        // Primeiro carregar clientes para o select
...
async function salvarEmprestimo() {
    try {
        ...
        console.log('💾 Salvando empréstimo na API:', emprestimoData);
...
async function excluirCliente(cpf) {
    ...
    try {
        // Para exclusão, precisaríamos de uma rota DELETE na API
...
async function atualizarDashboard() {
    try {
        ...
        document.getElementById('totalPendentes').textContent = emprestimos.length * 3; // Simulação
        document.getElementById('totalAtrasados').textContent = Math.floor(emprestimos.length * 0.3); // Simulação
